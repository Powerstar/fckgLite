...
NestedBulletList    : "Insert Nested Bullet List",
...
DlgBtnCancel		: "Cancel",
DlgBtnClose			: "Close",
DlgBtnBrowseServer	: "Browse Server/Upload",
...
VKIllustrationText: '<b>Top row functions from left-to-right</b><br />' 
                    + '1. Clicking on the language identifier or down arrow to its right opens a drop-down menu of languages; selecting one of these immediately changes the keyboard to the selected language. For an illustration of the drop-down menu scroll to the image at the bottom of this page.<br /> '
